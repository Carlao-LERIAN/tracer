...
func TestLimits_ListLimits_InvalidSortColumn(t *testing.T) {
	...
	req, err := http.NewRequest("GET", baseURL+"/v1/limits?sortBy=invalid_column;DROP+TABLE+limits;--&limit=10", nil)
	require.NoError(t, err)
	req.Header.Set("X-API-Key", apiKey)
...
func TestLimits_CreateLimit_Success(t *testing.T) {
	...
	uniqueName := "Integration Test Limit " + uuid.New().String()[:8]
...
func TestLimits_ListLimits_FilterByLimitType(t *testing.T) {
	...
	req, err := http.NewRequest("GET", baseURL+"/v1/limits?limit=10&limitType=DAILY", nil)
	require.NoError(t, err)
	req.Header.Set("X-API-Key", apiKey)
...
func TestLimits_UpdateLimit_Success(t *testing.T) {
	...
	// Update the limit
	newName := "Updated Limit Name " + uuid.New().String()[:8]
...
func TestLimits_FullLifecycle(t *testing.T) {
	...
	// 1. Create a limit
	uniqueName := "Lifecycle Test Limit " + uuid.New().String()[:8]
...
func TestLimits_CreateLimit_Monthly_ResetAtCalculated(t *testing.T) {
	...
	uniqueName := "Monthly Limit Test " + uuid.New().String()[:8]
	reqBody := createLimitRequest{
		Name:      uniqueName,
		LimitType: "MONTHLY",
		MaxAmount: 10000000,
		Currency:  "BRL",
		Scopes: []limitScopeInput{
			{SegmentID: testutil.Ptr(uuid.New().String())},
		},
	}
...
func TestLimits_CreateLimit_PerTransaction_ResetAtNull(t *testing.T) {
	...
	uniqueName := "Per Transaction Limit Test " + uuid.New().String()[:8]
	reqBody := createLimitRequest{
		Name:      uniqueName,
...
func TestLimits_CreateLimit_MultipleScopesArray(t *testing.T) {
	...
	uniqueName := "Multi Scope Limit Test " + uuid.New().String()[:8]
...
func TestLimits_GetUsage_PerTransaction(t *testing.T) {
	...
	uniqueName := "Per Transaction Usage Test " + uuid.New().String()[:8]
	reqBody := createLimitRequest{
		Name:      uniqueName,
		LimitType: "PER_TRANSACTION",
		MaxAmount: 50000,
...
func TestLimits_DeleteLimit_ExcludedFromList(t *testing.T) {
	...
	uniqueName := "Deleted Limit Test " + uuid.New().String()[:8]
	reqBody := createLimitRequest{
		Name:      uniqueName,
		LimitType: "DAILY",
		MaxAmount: 100000,
...
func TestLimits_CreateLimit_ValidationError_DescriptionWithXSS(t *testing.T) {
	...
	reqBody := createLimitRequest{
		Name:        "XSS Test Limit " + uuid.New().String()[:8],
...
func TestLimits_CreateLimit_ValidationError_InvalidScopeUUID(t *testing.T) {
	...
	reqBody := createLimitRequest{
		Name:      "Invalid Scope UUID Test " + uuid.New().String()[:8],
		LimitType: "DAILY",
		MaxAmount: 100000,
		Currency:  "USD",
		Scopes: []limitScopeInput{
...
func TestLimits_CreateLimit_ValidationError_InvalidTransactionTypeInScope(t *testing.T) {
	...
	reqBody := createLimitRequest{
		Name:      "Invalid Transaction Type Test " + uuid.New().String()[:8],
		LimitType: "DAILY",
		MaxAmount: 100000,
		Currency:  "USD",
		Scopes: []limitScopeInput{
...
func TestLimits_CreateLimit_ValidationError_ZeroMaxAmount(t *testing.T) {
	...
	reqBody := createLimitRequest{
		Name:      "Zero Amount Limit " + uuid.New().String()[:8],
		LimitType: "DAILY",
...
func TestLimits_CreateLimit_ValidationError_EmptyCurrency(t *testing.T) {
	...
	reqBody := createLimitRequest{
		Name:      "Empty Currency Limit " + uuid.New().String()[:8],
		LimitType: "DAILY",
		MaxAmount: 100000,
...
func TestLimits_CreateLimit_ValidationError_TooManyScopes(t *testing.T) {
	...
	reqBody := createLimitRequest{
		Name:      "Too Many Scopes Limit " + uuid.New().String()[:8],
		LimitType: "DAILY",
		MaxAmount: 100000,
		Currency:  "USD",
		Scopes:    scopes,
...
func TestLimits_CreateLimit_Success_ExactlyMaxScopes(t *testing.T) {
	...
	reqBody := createLimitRequest{
		Name:      "Max Scopes Limit " + uuid.New().String()[:8],
		LimitType: "DAILY",
		MaxAmount: 100000,
		Currency:  "USD",
		Scopes:    scopes,
...
func TestLimits_ListLimits_InvalidLimitTypeFilter(t *testing.T) {
	...
	req, err := http.NewRequest("GET", baseURL+"/v1/limits?limitType=INVALID", nil)
	require.NoError(t, err)
	req.Header.Set("X-API-Key", apiKey)
...
func TestLimits_ListLimits_InvalidSortOrder(t *testing.T) {
	...
	req, err := http.NewRequest("GET", baseURL+"/v1/limits?sortOrder=RANDOM", nil)
	require.NoError(t, err)
	req.Header.Set("X-API-Key", apiKey)
...
func TestLimits_CreateLimit_Boundary_DescriptionExactly1000Chars(t *testing.T) {
	...
	reqBody := createLimitRequest{
		Name:        "Boundary Test Limit " + uuid.New().String()[:8],
...
func TestLimits_CreateLimit_ResponseFields_Complete(t *testing.T) {
	...
	uniqueName := "Response Fields Test " + uuid.New().String()[:8]
...
func TestLimits_UpdateLimit_ResponseFields_UpdatedAtChanged(t *testing.T) {
	...
	newName := "Updated Name " + uuid.New().String()[:8]
	updateBody := updateLimitRequest{
		Name: &newName,
	}
...
func TestLimits_GetLimit_ResponseFields_Complete(t *testing.T) {
	...
	uniqueName := "Get Response Test " + uuid.New().String()[:8]
