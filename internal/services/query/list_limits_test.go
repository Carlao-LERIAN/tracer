...
func TestListLimitsQuery_Execute(t *testing.T) {
	...
	// After ApplyDefaults(), filters should have: Limit set, SortBy="createdAt", SortOrder="desc".
	...
	defaultFilterMatcher := filterMatcher(constant.DefaultPaginationLimit, "createdAt", string(constant.Desc))
	...
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *MockLimitRepository) {
				...
				// Verify defaults are applied: Limit=10, SortBy="createdAt", SortOrder="desc"
		...
		},
		{
			...
			setupMock: func(m *MockLimitRepository) {
				...
				// ApplyDefaults normalizes SortOrder to lowercase
				m.EXPECT().List(gomock.Any(), filterMatcher(constant.DefaultPaginationLimit, "createdAt", string(constant.Desc), statusCheck)).Return(result, nil)
			},
			expectError: false,
			validate: func(t *testing.T, result *model.ListLimitsResult) {
		...
		},
		{
			...
			setupMock: func(m *MockLimitRepository) {
				...
				// ApplyDefaults normalizes SortOrder to lowercase
				m.EXPECT().List(gomock.Any(), filterMatcher(constant.DefaultPaginationLimit, "createdAt", string(constant.Desc), limitTypeCheck)).Return(result, nil)
			},
			expectError: false,
			validate: func(t *testing.T, result *model.ListLimitsResult) {
				assert.Len(t, result.Limits, 2)
		...
		},
		{
			...
			setupMock: func(m *MockLimitRepository) {
				...
				// ApplyDefaults normalizes SortOrder to lowercase
				m.EXPECT().List(gomock.Any(), filterMatcher(constant.DefaultPaginationLimit, "createdAt", string(constant.Desc), combinedCheck)).Return(result, nil)
			},
			expectError: false,
			validate: func(t *testing.T, result *model.ListLimitsResult) {
				assert.Len(t, result.Limits, 2)
		...
		},
		{
			...
			setupMock: func(m *MockLimitRepository) {
				...
				// ApplyDefaults normalizes SortOrder to lowercase
				m.EXPECT().List(gomock.Any(), filterMatcher(2, "createdAt", string(constant.Desc))).Return(result, nil)
			},
			expectError: false,
			validate: func(t *testing.T, result *model.ListLimitsResult) {
				assert.Len(t, result.Limits, 2)
		...
		},
		{
			...
			setupMock: func(m *MockLimitRepository) {
				...
				// ApplyDefaults normalizes SortOrder to lowercase
				m.EXPECT().List(gomock.Any(), filterMatcher(10, "createdAt", string(constant.Desc), cursorCheck)).Return(result, nil)
			},
			expectError: false,
			validate: func(t *testing.T, result *model.ListLimitsResult) {
		...
		},
		{
			...
			setupMock: func(m *MockLimitRepository) {
				...
				// ApplyDefaults normalizes SortOrder to lowercase
				m.EXPECT().List(gomock.Any(), filterMatcher(constant.DefaultPaginationLimit, "createdAt", string(constant.Desc))).Return(result, nil)
			},
			expectError: false,
			validate: func(t *testing.T, result *model.ListLimitsResult) {
				assert.Len(t, result.Limits, 3)
...
func TestListLimitsQuery_Execute_NilFilter(t *testing.T) {
	...
	// filterMatcher verifies nil input gets defaults: Limit=10, SortBy="createdAt", SortOrder="desc"
