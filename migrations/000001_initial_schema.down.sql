...
-- Note: Functions and Event Triggers are dropped by their own down migrations in migrations/functions/
-- Note: No DROP TYPE needed - actor_type uses CHECK constraint, not ENUM
